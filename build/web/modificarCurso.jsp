<%-- 
    ...
    Created on : 24/10/2019, 04:21:24 AM
    Author     : amdza
--%>
            ...
            <div class="row">
                ...
                <form id="form1" name="form1" method="post" action="servletCurso">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="id_servicio" name="idCurso"  value="<%=c.getIdCurso() %>" disable="disable" required/>
                    </div>
                    <div class="form-group">
                        <label for="exampleNombreCurso">
                            Nombre Curso:
                        </label>
                        <input type="text" class="form-control" id="NombreCurso" name="NombreCurso"  placeholder="Nombre del curso..." value="<%=c.getNombreCurso() %>" maxlength="100" required/>
                    </div>
                    <div class="form-group">
                        <label for="exampleNivelCompetencia">
                            Nivel de Competencia :
                        </label>
                        <input type="text" class="form-control" id="NivelCompetencia" name="NivelCompetencia" placeholder="Nivel de Competencia..." value="<%=c.getNivelCompetencia() %>"maxlength="50" required/>
                    </div>
                    <div class="form-group">
                        <label for="exampleDescripcion">
                            Descripcion :
                        </label>
                        <input type="text" class="form-control" id="Descripcion" name="Descripcion" placeholder="Descripcion..." value="<%=c.getDescripcion() %>" maxlength="500" required/>
                    </div>
